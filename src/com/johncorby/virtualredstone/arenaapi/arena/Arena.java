...
public class Arena extends Identifiable<String> {
    public final static ConfigurationSection arenaSection = VirtualRedstone.CONFIG.getConfigurationSection("Arenas");
    ...
    public static List<String> getNames() {
        ...
        return Common.map(getArenas(), a -> a.get());
    }
    ...
    public boolean dispose() {
        ...
        new File(virtualRedstone.getDataFolder() + "/" + get() + ".schematic").delete();
    ...
    private void updateSign() {
        if (sign == null) return;
        sign.setLine(0, ChatColor.YELLOW + "[VirtualRedstone]");
        sign.setLine(1, get());
    ...
    private void getBlocks() {
        ...
        long time = Common.time(() -> {
            try {
                ...
                File file = new File(virtualRedstone.getDataFolder() + "/" + get() + ".schematic");
    ...
    public void tpToRandom(Player player) {
        Location l = new Location(WORLD,
                Common.randInt(region[0], region[2]),
                Common.randInt(0, 250),
                Common.randInt(region[1], region[3]),
                Common.randInt(-180, 180),
                0);
